...
//Boucle pour créer marqueurs qualité de l'air et ajouter les markers au groupe
...
//Boucle pour créer marqueurs météo et ajouter les markers au groupe
...
function weatherForecast(data){
    ...
    let myIcon = L.icon({
        iconUrl: `weather-icons-master/weather-icons-master/svg/${fileName}.svg`,
        iconSize: [60, 60]
    });
